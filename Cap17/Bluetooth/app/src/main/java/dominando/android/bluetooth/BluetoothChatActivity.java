...
public class BluetoothChatActivity extends AppCompatActivity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (mAdaptadorBluetooth != null) {
            ...
            Toast.makeText(this, R.string.msg_erro_bt_indisponivel,
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == BT_ATIVAR) {
            if (RESULT_OK != resultCode) {
                Toast.makeText(this, R.string.msg_ativar_bluetooth,
            ...
            if (resultCode == BT_TEMPO_DESCOBERTA) {
                ...
                Toast.makeText(this, R.string.msg_aparelho_invisivel,
                        Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    public void onClick(View v) {
        ...
        try {
            if (os != null) {
                os.writeUTF(msg);
                mMensagens.add(getString(R.string.minha_mensagem, msg));
    ...
    private class ThreadComunicacao extends Thread {
        ...
        public void run() {
            try {
                ...
                while (true) {
                    string = is.readUTF();
                    mTelaHandler.obtainMessage(MSG_TEXTO, nome + ": "
                            + string).sendToTarget();
                }
            } catch (IOException e) {
                e.printStackTrace();
