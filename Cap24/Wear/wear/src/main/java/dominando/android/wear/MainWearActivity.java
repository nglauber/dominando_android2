...
public class MainWearActivity extends Activity
    ...
    public void onPageSelected(int row, int column) {
        mPosicaoAtual = column;
        atualizarMobile(column);
    }
    @Override
        ...
        fdForAsset.setResultCallback(new ResultCallback<DataApi.GetFdForAssetResult>() {
            ...
            public void onResult(DataApi.GetFdForAssetResult getFdForAssetResult) {
                ...
                mViewPager.post(new Runnable() {
                    @Override
                    public void run() {
                        if (mPageAdapter == null || mPageAdapter.getColumnCount(0) != total) {
                            mPageAdapter = new ImagemPagerAdapter(getFragmentManager(), total);
                        ...
                        if (novaPosicao != mPosicaoAtual) {
                            ...
                            mViewPager.setCurrentItem(0, novaPosicao, true);
                            mViewPager.setOnPageChangeListener(MainWearActivity.this);
                        }
                    }
                });
    ...
    private void iniciarUI(WatchViewStub stub) {
        mViewPager = (GridViewPager) stub.findViewById(R.id.viewPager);
    ...
    class MensagensMobileReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (Constantes.ACAO_SAIR.equals(intent.getAction())) {
                ...
                final int novaPosicao = intent.getIntExtra(
                        Constantes.EXTRA_POSICAO_ATUAL, 0);
